      ...
      <div className="space-y-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            {/* Time Focused */}
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600 mb-2">0h</div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <div className="text-blue-600 font-semibold mb-1">Start Focus Session</div>
              <div className="text-sm text-blue-500">Begin a 25-minute focus timer</div>
            </motion.button>
            ...
            >
              <div className="text-green-600 font-semibold mb-1">Add New Task</div>
              <div className="text-sm text-green-500">Create a new to-do item</div>
            </motion.button>
            ...
            >
              <div className="text-purple-600 font-semibold mb-1">View Analytics</div>
              <div className="text-sm text-purple-500">Check your productivity insights</div>
            </motion.button>
          </div>
        </motion.div>
